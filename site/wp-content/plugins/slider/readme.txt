...
* Start slides with sequential order.
* Start slides with random order.
* Super Fast Slider powered with 2D & 3D Animations.
...
* Added more than 50 CSS3 animations to play with
* Animation duration option
* Super smooth animations
* Custom duration option for slides
* Add Videos on a slide
* Auto play delay option for slides
